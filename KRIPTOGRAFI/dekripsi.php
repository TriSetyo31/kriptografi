...
<head>
	<meta charset="UTF-8">
	<title>Tri Setyobudi 20670066</title>
</head>
...
<html lang="en">
  <head>
    ...
    <title>KRIPTOGRAFI CHIPER</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">TRI SETYOBUDI 20670066</a>
        </div>
	...
	<table class="table table-hover" style="width:80%; padding:100px;">
		<tr>
			<td colspan="3">
				<h1 style="text-align:center;">TRI SETYOBUDI 20670066</h1>
			</td>
		</tr>
		<tr>
			<td>CipherText</td>
		...
		<tr>
			<td colspan="3">
				...
				<input name="btnDe" class="btn btn-primary" value="Decrypt" onclick="Decrypt()" type="button"></p>
			</td>
		</tr>
		<tr>
			<td>PlainText</td>
